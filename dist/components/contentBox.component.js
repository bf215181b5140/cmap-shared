...
exports.ContentBox = exports.Content = void 0;
    ...
    function getFlexBasis() {
        ...
        switch (props.flexBasis) {
            ...
            case index_1.ContentBoxWidth.Third:
                return "calc(100% * (1 / 3) - ".concat(CONTENT_GAP, ")");
            case index_1.ContentBoxWidth.Half:
                return "calc(100% * (1 / 2) - ".concat(CONTENT_GAP, ")");
