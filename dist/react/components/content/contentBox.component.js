...
export default function ContentBox(props) {
    ...
    return (_jsxs(ContentBoxWrapper, { flexGrow: props.flexGrow, flexBasis: getFlexBasis(), children: [props.title && _jsx(ContentBoxTitle, { shown: shown, children: _jsxs("h2", { onClick: () => setShown(prevState => !prevState), children: [_jsx("i", { className: 'ri-arrow-down-s-line' }), props.title] }) }), shown && _jsx(ContentBoxStyled, { children: props.loading !== true ? props.children : _jsx(ContentLoading, { children: _jsx("div", { className: 'loader' }) }) })] }));
}
