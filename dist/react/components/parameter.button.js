...
function ParameterButton(props) {
    ...
    if (props.button.buttonType === index_1.ButtonType.Slider) {
        return ((0, jsx_runtime_1.jsx)(ParameterSliderStyled, { type: "range", step: 1, className: props.buttonStyle.className, flexBasis: props.flexBasis, onClick: function (e) { return onClick(props.button.id, e.target.value); }, min: props.button.valueType === index_1.ValueType.Float ? (Number(props.button.value) * 100) : props.button.value, max: props.button.valueType === index_1.ValueType.Float ? (Number(props.button.valueAlt) * 100) : props.button.valueAlt }));
    }
