...
function ParameterButton(props) {
    ...
    if (props.button.buttonType === index_1.ButtonType.Slider) {
        return ((0, jsx_runtime_1.jsxs)(UseCostWrapper, { children: [(0, jsx_runtime_1.jsxs)(SliderWrapper, { children: [props.button.label && (0, jsx_runtime_1.jsx)(ParameterSliderLabel, { children: props.button.label }), (0, jsx_runtime_1.jsx)(parameter_slider_1.default, { disabled: !!props.disabled || !useCostUsable(), className: props.buttonStyle.className, onClick: (value) => onClick(value), value: typeof props.value === 'number' ? props.value : 0, step: props.button.valueType === index_1.ParameterValueType.Float ? 0.01 : 1, min: Number(props.button.value), max: Number(props.button.valueAlt) })] }), props.button.useCost && (0, jsx_runtime_1.jsx)(UseCostIcon, { position: "top", background: expOrb_png_1.default, usable: useCostUsable(), children: props.button.useCost.toString() })] }));
    }
