...
function ParameterButton(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ParameterButtonStyled, __assign({ flexBasis: props.flexBasis, disabled: !!props.disabled, className: props.buttonStyle.className, onClick: function () { return onClick(); } }, { children: (0, jsx_runtime_1.jsxs)(ActiveOverlay, __assign({ active: !!props.active }, { children: [props.button.image && (0, jsx_runtime_1.jsx)(ParameterButtonPicture, { src: exports.URL + '/' + props.button.image, imageOrientation: props.button.imageOrientation }), props.button.label && (0, jsx_runtime_1.jsx)(ParameterButtonLabel, { children: props.button.label })] })) })));
}
